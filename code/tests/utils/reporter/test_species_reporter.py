...
class FitnessEvaluationUtilsTest(TestCase):
    ...
    def test_add_generation_fitness_reporter(self):
        self.assertIsNone(self.species_reporter.data.min_generation)
        self.assertIsNone(self.species_reporter.data.max_generation)
        self.assertEqual({}, self.species_reporter.data.species_size_dict)
        ...
        self.assertEqual(3, self.species_reporter.data.max_generation)
        self.assertEqual({1: ([3], [7])}, self.species_reporter.data.species_size_dict)
        ...
        self.assertEqual(3, self.species_reporter.data.min_generation)
        self.assertEqual(4, self.species_reporter.data.max_generation)
        self.assertEqual({1: ([3, 4], [7, 3]),
                          2: ([4], [3]),
                          3: ([4], [1])},
                         self.species_reporter.data.species_size_dict)
        ...
        self.assertEqual(3, self.species_reporter.data.min_generation)
        self.assertEqual(5, self.species_reporter.data.max_generation)
