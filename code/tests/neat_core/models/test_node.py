...
class NodeTest(TestCase):
    ...
    def test_node(self):
        input_node = Node(1, NodeType.INPUT, 0.3, modified_sigmoid_activation, 0)
        output_node = Node(2, NodeType.OUTPUT, 0.4, modified_sigmoid_activation, 1)
        hidden_node = Node("hidden_node", NodeType.HIDDEN, 0.6, modified_sigmoid_activation, 0.5)
