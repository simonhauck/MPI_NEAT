...
def draw_genome_graph(genome: Genome, draw_labels=True, plot: bool = False) -> None:
    ...
    for connection in genome.connections:
        graph.add_edge(connection.input_node, connection.output_node, label=round(connection.weight, 4))
...
def _sort_nodes_in_layers(genome: Genome) -> Dict[float, List[Node]]:
    """
