...
from examples.breakout.breakout_challenge import BreakoutChallenge
...
from utils.visualization import reporter_visualization, text_visualization, genome_visualization


class BreakoutOptimizer(BaseExample):
    ...
    def evaluate(self, optimizer: NeatOptimizer, seed: int = None, **kwargs):
        ...
        self.check_point_reporter = CheckPointReporter("/tmp/breakout/{}/".format(time), "breakout",
                                                       lambda _: True)
